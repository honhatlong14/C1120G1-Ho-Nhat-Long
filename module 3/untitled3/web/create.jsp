...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto margin-navbar">
            ...
            <li class="nav-item active margin-navbar">
                <a class="nav-link width-text" href="?actionUser=listProduct">Danh Sách Nguoi thue</a>
            </li>
        </ul>
                ...
                <form method="post" id="validate">
                    <table cellpadding="5">
                        <tr>
                            <th>Ma Phong:</th>
                            <td>
                                <input type="text" name="ma phong" size="45" required/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>so dien thoai:</th>
                            <td>
                                <input type="text" name="so dien thoai" size="45" required/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>ngay thue:</th>
                            <td>
                                <input type="text" name="ngay thue" size="45" required/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                                <input type="submit" value="them mới"/>
                            </td>
                        </tr>
                    </table>
                </form>
