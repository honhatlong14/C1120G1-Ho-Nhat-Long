...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <form method="post">
                <label>Sản phẩm được đặt từ</label>
                ...
                <br>
                <label>Danh Sách Top</label>
                <input type="dropdown" name="top" style="margin-left: 5%; margin-right: 5%">
                <label>Sản Phẩm được đặt hàng nhiều nhất</label>
                <input type="submit" value="xem">
            </form>
